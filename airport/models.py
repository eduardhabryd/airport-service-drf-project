...
class Route(models.Model):
	...
	def __str__(self):
		return f"ROUTE: {self.source.closest_big_city} - {self.destination.closest_big_city}. DISTANCE: {self.distance}"
...
class Flight(models.Model):
	...
	def __str__(self):
		return f"FLIGHT: {self.departure_time} - {self.arrival_time}. ROUTE: {self.route}"
